package snake.model.basictypes;
     ...
     */
//public class PromoMove extends Move{
public class PromoMove {
    /**
    ...
    public PromoMove(Field fromField, Field toField, Piece promotionPiece) {
